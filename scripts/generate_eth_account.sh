...
echo "Address Stored:"
echo $ADDR | docker secret create ETH_ADDRESS -
echo

echo "Private Key Stored:"
echo $PK | docker secret create ETH_PRIVATE_KEY -
echo

echo -e "PLEASE SEND 25000 TNT TO $ADDR IN ORDER TO STAKE, THEN RUN make stake"
