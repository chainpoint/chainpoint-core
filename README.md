...
Please fund your Lightning address with at least [minimum required balance] Satoshis (0.0X BTC) and wait for 6 confirmations, then run `make deploy`
...
The minimum required balance is determined by the number of cores on the Chainpoint Network multiplied by 1,000,000 satoshis.
